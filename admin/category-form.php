...
if(isset($_POST['save'])){
    $query = $db->prepare('INSERT INTO faq_category (category_name) VALUES (?)');
				...
				<section class="col-9">
					...
					<form action="category-form.php" method="post" enctype="multipart/form-data">
						<div class="form-group">
							...
							<input class="form-control" value="<?= isset($category) ? htmlentities($category['category_name']) : '';?>" type="text" placeholder="Nom" name="name" id="name" />
						</div>
